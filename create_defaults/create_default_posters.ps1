...
Function CreateCountry {
    ...
    $myArray = @(
        ...
        'nordic.png| 1500| NORDIC| Nordic| #A12398',
        ...
        'tw.png| 1500| TAIWAN| Taiwan| #ABE3E0',
...
Function CreateStudio {
    ...
    $arr += ".\create_poster.ps1 -logo `"$script_path\logos_studio\Sunrise.png`" -logo_offset +0 -logo_resize 1600 -text `"`" -text_offset +0 -font `"ComfortAa-Medium`" -font_size 250 -font_color `"#FFFFFF`" -border 0 -border_width 15 -border_color `"#FFFFFF`" -avg_color_image `"`" -out_name `"Sunrise`" -base_color `"#C11D1D`" -gradient 1 -clean 1 -avg_color 0 -white_wash 0"
    $arr += ".\create_poster.ps1 -logo `"$script_path\logos_studio\Toei Animation.png`" -logo_offset +0 -logo_resize 1600 -text `"`" -text_offset +0 -font `"ComfortAa-Medium`" -font_size 250 -font_color `"#FFFFFF`" -border 0 -border_width 15 -border_color `"#FFFFFF`" -avg_color_image `"`" -out_name `"Toei Animation`" -base_color `"#BB5048`" -gradient 1 -clean 1 -avg_color 0 -white_wash 0"
