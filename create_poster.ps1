...
if ($font_color -eq "" -or $null -eq $font_color) {
  $font_color = "#FFFFFF"
}
...
# $border_width checks
#################################
if ($border_width -eq "" -or $null -eq $border_width) {
  $border_width = 15
}
...
# $font_size checks
#################################
if ($font_size -eq "" -or $null -eq $font_size) {
  $font_size = 250
}
...
# $border_color checks
#################################
if ($border_color -eq "" -or $null -eq $border_color) {
  $border_color = "#FFFFFF"
}
...
# $logo_offset checks
#################################
if ($logo_offset -eq "" -or $null -eq $logo_offset) {
  $logo_offset = "+0"
}
...
# $text_offset checks
#################################
if ($text_offset -eq "" -or $null -eq $text_offset) {
  $text_offset = "+0"
}
